      ...
      <div>
          ...
          >
            <div>
              <Typography
                ...
                variant="h6"
                component="h2"
                sx={{ textAlign: 'center', color: '#E50914' }}
              >
                Select your preferences
              </Typography>
              <Typography>Sort the page result</Typography>
              ...
              {!location.search && (
                <div>
                  <Typography>Filter per category</Typography>
                  <FormControl sx={{ m: 1, minWidth: 120 }}>
                    <Select
                      value={category}
              ...
              <div>
                <Typography>Production Year Range</Typography>
                <Slider
        ...
        <Grid container spacing={4}>
          ...
          {error && (
            <p>
              {' '}
              Nothing was found. Please try to type the exact name in the
              English version.
            </p>
          )}
          {!state.loading &&
